...
const CustomerForm = (function() {
    ...
    async function logMachineHistory(machineId, oldValues, newValues, changedBy) {
        console.warn('Machine history write skipped: legacy Firebase customer editor is disabled.', { machineId, oldValues, newValues, changedBy });
    }
     ...
     */
    async function save() {
        MargaUtils.showToast('Customer edits are disabled until the Margabase write API replaces the old Firebase writer.', 'error');
    }
