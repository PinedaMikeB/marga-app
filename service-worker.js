const CACHE_NAME = 'marga-app-shell-v83-billing-customer-statement';
...
const SHELL_ASSETS = [
    ...
    '/billing/',
    '/billing/index.html',
    '/billing/css/billing.css?v=20260526-customer-statement-1',
    '/billing/js/billing.js?v=20260526-customer-statement-1',
    '/customers/',
