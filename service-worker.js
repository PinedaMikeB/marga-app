const CACHE_NAME = 'marga-app-shell-v89-billing-dec-range-saved-queue';
...
const SHELL_ASSETS = [
    ...
    '/billing/',
    '/billing/index.html',
    '/billing/css/billing.css?v=20260528-dec-range-saved-queue-1',
    '/billing/js/billing.js?v=20260528-dec-range-saved-queue-1',
    '/customers/',
