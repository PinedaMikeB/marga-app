const CACHE_NAME = 'marga-app-shell-v140-contacts-first-followup-pack';
...
const SHELL_ASSETS = [
    ...
    '/billing/',
    '/billing/index.html',
    '/billing/css/billing.css?v=20260608-invoice-proof-panel-1',
    '/billing/js/billing.js?v=20260609-soa-policy-2025-1',
    '/customers/',
    ...
    '/collections.html',
    '/collections/js/collections.js?v=20260610-contacts-first-followup-pack-1',
    '/shared/js/soa-policy.js?v=20260609-service-soa-1',
    '/field/',
    '/field/index.html',
    '/field/css/field.css?v=20260608-reimbursement-storage-1',
    '/field/js/field.js?v=20260609-billing-invoice-restore-1',
    '/expenses/',
    '/expenses/index.html',
    '/expenses/css/expenses.css?v=20260608-global-requests-1',
    '/expenses/js/expenses.js?v=20260609-item-group-catalog-1',
    '/hr/',
    '/hr/index.html',
    ...
    '/pettycash/css/pettycash.css?v=20260609-item-group-catalog-1',
    '/pettycash/js/pettycash.js?v=20260609-item-group-catalog-1',
    '/accounting/',
    ...
    '/service/',
    '/service/index.html',
    '/service/css/service.css?v=20260609-service-soa-1',
    '/service/js/dispatch-board.js?v=20260609-service-soa-1',
    '/service/js/service-soa.js?v=20260609-service-soa-1',
    ...
    '/shared/js/reimbursement-daily-register.js?v=20260609-item-group-catalog-1',
