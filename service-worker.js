const CACHE_NAME = 'marga-app-shell-v208-master-field-bucket-tally-1';
...
const SHELL_ASSETS = [
    ...
    '/billing/js/billing.js?v=20260701-billing-cbs-branch-quota-fix-1',
    '/customers/',
    ...
    '/collections.html',
    '/collections/js/collections.js?v=20260625-collections-field-assignee-fix-1',
    '/master-schedule.html',
    '/master-schedule/js/master-schedule.js?v=20260720-master-field-bucket-tally-1',
    '/field/',
    '/field/index.html',
    ...
    '/service/js/dispatch-board.js?v=20260624-service-release-dr-identity-1',
    ...
    '/shared/js/auth.js?v=20260706-login-alias-fix-1',
