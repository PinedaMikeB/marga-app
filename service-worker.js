const CACHE_NAME = 'marga-app-shell-v179-master-manual-assign-override-1';
...
const SHELL_ASSETS = [
    ...
    '/billing/js/billing.js?v=20260622-billing-pird-print-2',
    '/customers/',
    ...
    '/master-schedule/js/master-schedule.js?v=20260623-manual-assignment-override-1',
    '/field/',
    '/field/index.html',
    '/field/css/field.css?v=20260622-field-modal-mobile-fix-1',
    '/field/js/field.js?v=20260623-field-delivery-close-relax-1',
    '/purchasing/',
    ...
    '/pettycash/js/pettycash.js?v=20260622-pettycash-loading-progress-1',
    '/accounting/',
