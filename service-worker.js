const CACHE_NAME = 'marga-app-shell-v96-digitalocean-cache-guard';
...
const SHELL_ASSETS = [
    ...
    '/collections.html',
    '/collections/js/collections.js?v=20260528-payment-import-digital-1',
    '/field/',
    '/field/index.html',
    ...
    '/shared/js/offline-sync.js?v=20260530-digitalocean-cache-guard-1',
